$(document).ready(function () {
    ...
    var ranges = [
        { id: 1, text: 'from 0 to 500' },
        { id: 2, text: 'from 500 to 1000' },
        { id: 3, text: 'from 1000 to 5000' },
        { id: 4, text: 'from 5000 to 10000' },
        { id: 5, text: 'from 10000 to 50000' },
        { id: 6, text: 'from 50000 to 100000' },
        { id: 7, text: 'more than 100000' }
    ]
    $('.ranges').select2({
        data: ranges
    })
    ...
    $('.help-info li a').click(function (e) {
        e.preventDefault();
        $(this).addClass('active').closest('li').siblings().find('a').removeClass('active');
        idtext = $(this).attr('href').substring(1);
